					...
					<div class="col-lg-10 col-md-10">
						...
						<div class="row">
							...
							<div class="col-lg-7">
								...
								<h6><i class="fas fa-map-marker" aria-hidden="true"></i> {{Auth::user()->getLocation()}}</h6>
						...
						<ul class="row userdata">
							...
							<li class="col-lg-6 col-md-6"><i class="fas fa-phone" aria-hidden="true"></i> {{auth()->user()->phone}}</li>							

							<li class="col-lg-6 col-md-6"><i class="fas fa-envelope" aria-hidden="true"></i> {{auth()->user()->email}}</li>
