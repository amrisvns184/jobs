        ...
        <div class="job-header">
            ...
            <div class="jobButtons">
				...
				<div class="job-header benefits">
                    <div class="contentbox">
                        <h3><i class="fa fa-file-text" aria-hidden="true"></i> {{__('Qualifications and Key Competencies')}}</h3>
                        <p>{!! $job->benefits !!}</p>                       
                    </div>
                </div>
				...
				<div class="job-header">
                    <div class="contentbox">                        
                        <h3><i class="fas fa-puzzle-piece" aria-hidden="true"></i> {{__('Mandatory Requirements')}}</h3>
                        <ul class="skillslist">
