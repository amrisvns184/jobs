...
<div class="row">  
    ...
    <div class="col-md-12">
	 ...
	 <div class="col-md-12">
        ...
        <label for="">Qualification and Key Competencies</label>    
        {!! Form::textarea('benefits', null, array('class'=>'form-control', 'id'=>'benefits', 'placeholder'=>__('Job qualification and key competencies'))) !!}
            {!! APFrmErrHelp::showErrors($errors, 'qualifications') !!} </div>
    </div>
	
	
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'skills') !!}">
        <label for="">Mandatory Requirements</label>    
            <?php
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.select2-multiple').select2({
            placeholder: "{{__('Select Mandatory Requirements')}}",
            allowClear: true
        });
